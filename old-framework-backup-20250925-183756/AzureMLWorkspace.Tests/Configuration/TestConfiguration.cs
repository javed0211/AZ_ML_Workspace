...
public class TestConfiguration
{
    ...
    public string BaseUrl => "https://ml.azure.com";
    public string TestDataPath => GetCrossPlatformPath("TestData");
    public string ScreenshotsPath => GetCrossPlatformPath("Screenshots");
    public string VideosPath => GetCrossPlatformPath("Videos");
    public string TracesPath => GetCrossPlatformPath("Traces");
    public string LogPath => GetCrossPlatformPath("Logs");
    
    // Browser legacy properties
    public int DefaultTimeout => Browser.DefaultTimeout;
    public bool HeadlessMode => Browser.Headless;
    public string BrowserType => Browser.DefaultBrowser;
    public bool SlowMo => Browser.SlowMo > 0;
    public int SlowMoDelay => Browser.SlowMo;
    
    // Capture legacy properties
    public bool CaptureScreenshots => Browser.CaptureScreenshots;
    public bool CaptureVideos => Browser.CaptureVideos;
    public bool CaptureTraces => Browser.CaptureTraces;
    
    // Logging legacy properties
    public string LogLevel => Logging.LogLevel;
...
public class AzureConfiguration
{
    ...
    public string DataScientistRoleId { get; set; } = string.Empty;
}

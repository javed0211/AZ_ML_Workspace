...
exports.VSCodeDesktopAutomation = void 0;
...
class VSCodeDesktopAutomation {
    ...
    async connectToRemoteCompute(computeName) {
        try {
            if (!this.mainWindow) {
                throw new Error('VS Code is not launched');
            }
    ...
    async findVSCodeExecutable() {
        ...
        for (const vscPath of possiblePaths) {
            try {
                await fs_1.promises.access(vscPath);
                return vscPath;
            }
            catch {
                continue;
...
exports.VSCodeDesktopAutomation = VSCodeDesktopAutomation;
...
//# sourceMappingURL=vscode-automation.js.map